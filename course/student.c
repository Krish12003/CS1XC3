 ...
 * @brief Implementations for the student library.
 * @version 1
 * @date 2022-04-12
 *
 */
...
/**
 * @brief Add a grade to a student's grade array
 *
...
/**
 * @brief Given a pointer to a student, and return the average of the student's grades
 *
 * @param student a pointer to a Student struct
 *
...
/**
 * @brief Print the given student's name, id, grades, and average
 *
 * @param student a pointer to a Student struct
 */
...
/**
 * @brief Generates a random student with random grades
 *
